...
public class List extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		if (itemsCount > 0) {
			list2 = new List2(this, items, db);
			ItemsListView.setAdapter(list2);
		} else {
        ...
        SmsButton.setOnClickListener(view -> {
            ...
            AlertDialog = SMS.doubleButton(this);
            AlertDialog.show();
        });
        ...
        DelAllItemsButton.setOnClickListener(view -> {
			...
			if (itemsCount > 0) {
				...
				AlertDialog = Delete.doubleButton(this);
				AlertDialog.show();
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (requestCode == 1) {
			if (resultCode == RESULT_OK) {
				...
				list2.items = (ArrayList<Item>) db.getAllItems();
