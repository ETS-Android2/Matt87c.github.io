...
public class Add extends AppCompatActivity {
    ...
    String ItemName, EmailHolder, DescHolder, QtyHolder, UnitHolder;
    TextView UserEmail;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EmailHolder = intent.get().getStringExtra(List.UserEmail);
    ...
    public void InsertItemIntoDatabase() {
        ...
        if (!EmptyHolder) {
            ...
            Item item = new Item(name, email, desc, qty, unit);
        	db.createItem(item);
